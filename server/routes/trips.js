...
router.patch('/:id/status', authenticateToken, async (req, res) => {
    ...
    try {
        ...
        // Update Trip Status
        // When final_odometer present:  SET status=$1, final_odometer=$2 WHERE id=$3
        // When final_odometer absent:   SET status=$1 WHERE id=$2
        const updateTripQuery = final_odometer
            ? 'UPDATE trips SET status = $1, final_odometer = $2 WHERE id = $3 RETURNING *'
