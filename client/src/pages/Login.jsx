...
const DEMO_ROLES = [
  { email: 'manager@transitops.test', role: 'Fleet Manager', icon: Truck, color: 'bg-indigo-50 border-indigo-200 text-indigo-700' },
  { email: 'dispatcher@transitops.test', role: 'Dispatcher', icon: MapPin, color: 'bg-blue-50 border-blue-200 text-blue-700' },
  { email: 'safety@transitops.test', role: 'Safety Officer', icon: Shield, color: 'bg-emerald-50 border-emerald-200 text-emerald-700' },
  { email: 'analyst@transitops.test', role: 'Financial Analyst', icon: BarChart3, color: 'bg-amber-50 border-amber-200 text-amber-700' },
]
    ...
    <div className="min-h-screen relative flex items-center justify-center p-6 bg-[#f8fafc] overflow-hidden">
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-display font-extrabold text-slate-900 tracking-tight">TransitOps</h1>
        ...
        <div className="glass-panel rounded-2xl p-8 backdrop-blur-2xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
            ...
            >
              {isLoading ? <><LoadingSpinner size="sm" /> Signing in...</> : 'Sign in to TransitOps'}
            </button>
          </form>
        ...
        <p className="text-center text-xs font-medium text-slate-400 mt-8">
          TransitOps v1.0 &middot; Built for Odoo Hackathon 2025
        </p>
      </div>
